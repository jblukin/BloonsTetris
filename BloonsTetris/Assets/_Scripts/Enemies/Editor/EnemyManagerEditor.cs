...
public class EnemyManagerEditor : Editor
{
    ...
    public override VisualElement CreateInspectorGUI()
    {
        ...
        inspector.Add( new Button( () => { ( target as EnemyManager ).SpawnEnemy( typeof( ShielderEnemy ) ); } ) { text = "Spawn Shielder Enemy", style = { flexGrow = 1, flexShrink = 1, minHeight = 15, marginTop = 5 } } );
